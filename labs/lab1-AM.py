...
def plot_DSB_SC_modulation(t, m, c, DSB_SC_signal):
    libplot.plot_signals(t,
        ...
        save_path="figures/lab1_DSB_SC.pdf"
    )

###SPECTRES
def plot_A3_spectrum(t, A3_signal):
    libplot.plot_spectrum(t, A3_signal_fft, title="Spectre du signal A3", save_path="figures/lab1_A3_spectrum.pdf")

def plot_DSB_SC_spectrum(t, DSB_SC_signal):
    libplot.plot_spectrum(t, DSB_SC_signal_fft, title="Spectre du signal DSB-SC", save_path="figures/lab1_DSB_SC_spectrum.pdf")
...
def plot_A3_demodulation_crete(t, A3_demodulated_crete):
    libplot.plot_signals(t,
        ...
        save_path="figures/lab1_A3_demodulation.pdf"
    )
...
def plot_A3_demodulation_coherent(t, A3_demodulated_coherent):
    libplot.plot_signals(t,
        ...
        title="Démodulation du signal A3",
        save_path="figures/lab1_A3_demodulation_coherent.pdf"
    )
    
def plot_XY_A3_modulant_démodulé_crete(m_fft, A3_demodulated_crete):
    libplot.XY_plot(m_fft, A3_demodulated_crete, title="XY Plot du signal modulant vs signal démodulé", save_path="figures/lab1_XY_modulant_modulé.pdf")

def plot_XY_A3_modulant_démodulé_coherent(m_fft, A3_demodulated_coherent):
    libplot.XY_plot(m_fft, A3_demodulated_coherent, title="XY Plot du signal modulant vs signal démodulé", save_path="figures/lab1_XY_modulant_modulé_coherent.pdf")

def plot_XY_A3_modulant_modulé(m_fft, A3_signal_fft):
    libplot.XY_plot(m_fft, A3_signal_fft, title="XY Plot du signal modulant vs signal modulé", save_path="figures/lab1_XY_modulant_modulé.pdf")

def plot_XY_DSB_SC_modulant_modulé(m_fft, DSB_SC_signal_fft):
    libplot.XY_plot(m_fft, DSB_SC_signal_fft, title="XY Plot du signal modulant vs signal modulé", save_path="figures/lab1_XY_modulant_modulé_DSB_SC.pdf")
...
def plot_DSB_SC_demodulation_crete(t, DSB_demodulated_crete):
    libplot.plot_signals(t,
        ...
        save_path="figures/lab1_DSB_SC_demodulation_crete.pdf"
    )
...
def plot_DSB_SC_demodulation_coherent(t, DSB_demodulated_coherent):
    libplot.plot_signals(t,
        ...
        save_path="figures/lab1_DSB_SC_demodulation_coherent.pdf"
    )

def plot_XY_DSB_SC_modulant_démodulé(m_fft, DSB_demodulated_crete, DSB_demodulated_coherent):
    libplot.XY_plot(m_fft, DSB_demodulated_crete, title="XY Plot du signal modulant vs signal démodulé (détecteur de crête)", save_path="figures/lab1_XY_DSB_SC_modulant_démodulé_crete.pdf")
    libplot.XY_plot(m_fft, DSB_demodulated_coherent, title="XY Plot du signal modulant vs signal démodulé (démodulation cohérente)", save_path="figures/lab1_XY_DSB_SC_modulant_démodulé_coherent.pdf")

def plot_XY_DSB_SC_modulant_modulé(m_fft, DSB_SC_signal_fft):
    libplot.XY_plot(m_fft, DSB_SC_signal_fft, title="XY Plot du signal modulant vs signal modulé", save_path="figures/lab1_XY_DSB_SC_modulant_modulé.pdf")
